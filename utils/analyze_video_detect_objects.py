...
class VideoClipAnalyzer:
    ...
    def _download_model_files(self, model_dir):
        ...
        model_files = {
            ...
            # Using a reliable SourceForge mirror for the weights file to avoid 403 Forbidden
            'yolov3.weights': 'https://master.dl.sourceforge.net/project/yolov3.mirror/v8/yolov3.weights?viasf=1',
    ...
    def analyze_clip(self, clip_path):
        ...
        while True:
            ...
            # Process every 5th frame to reduce processing load and speed up execution
            if frame_count % 5 == 0:
